...
const randomComments = [
    ...
    "THIS! 💯 #This",
    "Mood. 😂 #Mood",
    "My life in a nutshell. 😂 #MyLife",
    "Love this! 💖 #Love",
    "LOL 😂 #LOL",
    "LMAO 😂 #LMAO",
    "You got this! 💪 #Motivation",
    "WOW! 😱 #Wow",
    "Aww, this is so sweet! 🥰 #Sweet",
    "Amazing! 😍 #Amazing",
    "So wise! 🙌 #Wise",
    ...
    "Just livin' life to the fullest! 🌟 #Joyful",
    "Soaking up the good vibes. 🌞 #GoodVibesOnly",
    "Scream it from the rooftops! 🗣️ #Yolo",
    "Let's get lost in this moment. 🌟 #Blissful",
    "Why not take a chance? 🤷‍♀️ #YOLO",
    "What's life without a little adventure? 🌄 #AdventureTime",
    "Who's with me? 🙋‍♀️ #AdventureAwaits",
    "Don't let anyone dull your sparkle. ✨ #ShineBright",
    "Don't let anyone stop you from chasing your dreams. 🌟 #DreamBig",
    "Find your tribe and love them hard. 💖 #SquadGoals",
